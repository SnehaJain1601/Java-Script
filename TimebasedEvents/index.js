...
// a.setTimeout(delayedFunction, 2000);
// b.setTimeout(() => delayedFunction(5), 2000);
...
// This function should log the message 
// "This function repeats every 1000 milliseconds (1 second)" to the console. 
