...
//todo 2:  Promise Made:  Your friend promises to call you after 2 days at 6 pm. 
// This is similar to creating a promise in JavaScript.

//todo 3:  Pending Stage:  During the 2-day period, you're in a "pending" stage. 
// You're not sure whether your friend will fulfill the promise (call you) 
// or break the promise (not call you). Similarly, 
// when you create a promise in JavaScript, it starts in a pending state 
// until it either resolves (fulfills) or rejects.

//todo 4: Resolution at a Specific Time:  After 2 days and exactly at 6 pm, 
// you'll know whether the promise is fulfilled (resolved) if your friend calls you, 
// or if it's broken (rejected) if your friend doesn't call. 
// This aligns with the idea that promises in JavaScript resolve or reject, 
// often triggered by asynchronous operations, at a specific point in time.
...
// This function usually encapsulates some asynchronous operation. 
// Inside this function, you manually create a promise and resolve or reject it
//  based on the result of the asynchronous operation.
...
// 2: the moment we use setTimeout, we need to handle promises, 
// we can do using then and catch
